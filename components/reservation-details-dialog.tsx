                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span
                          className={`font-medium ${daysRemaining < 0 ? "text-red-600" : daysRemaining <= 7 ? "text-orange-600" : "text-green-600"}`}
                        >
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Esta acción enviará la reserva de {r.nombreCliente} a la papelera. Podrás recuperarla desde
                            la sección "Papelera" en los próximos 7 días, después de los cuales se eliminará
                            permanentemente.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
