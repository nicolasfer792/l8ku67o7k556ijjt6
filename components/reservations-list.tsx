  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-2">
        ...
        {byDate.map((r) => (
          <div key={r.id} className="flex flex-col sm:flex-row gap-2 sm:items-center border rounded-md p-2">
            ...
            <Button variant="ghost" size="icon" onClick={() => enviarReservaAPapelera(r.id)} aria-label="Eliminar">
